...
const ViennaStationsListItemComponent = (props: ViennaStationsListItemProps): ReactElement => {
...
export const ViennaStationsListItem = memo(ViennaStationsListItemComponent);
